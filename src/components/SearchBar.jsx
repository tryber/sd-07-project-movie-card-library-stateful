        ...
        <fieldset>
          <div>
            <label htmlFor="searchText" data-testid="text-input-label">
              ...
              <input name="searchText" data-testid="text-input" type="text" value={searchText} onChange={onSearchTextChange} pattern="[A-zÀ-ÿ ]{1,}">
              </input>
          </div>
          <div>
            <label htmlFor="checkbox" data-testid="checkbox-input-label">
                Mostrar somente favoritos</label>
              <input name="bookmarkedOnly" data-testid="checkbox-input" type="checkbox" checked={bookmarkedOnly} onChange={onBookmarkedChange}>
              </input>
          </div>
          <div>
