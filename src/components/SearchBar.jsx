  ...
  render() {
    ...
    return (
      <form data-testid="search-bar-form">
        ...
        <label htmlFor="fav-checkbox" data-testid="checkbox-input-label">
        ...
        <label htmlFor="genre-select" data-testid="select-input-label">
          Filtrar por gênero
          <select id="genre-select" value={selectedGenre} onChange={onSelectedGenreChange} data-testid="select-input">
