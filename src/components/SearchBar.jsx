...
class SearchBar extends React.Component {
  ...
  <form data-testid="search-bar-form">
    ...
    <div>
      ...
      <input htmlFor="bookmarkedOnly" name="bookmarkedOnly" type="checkbox" id="bookmarkedOnly"
    ...
    <div>
      <label data-testid="select-input-label">
        ...
        <select htmlFor="selectedGenre" name="selectedGenre" data-testid="select-input"
