...
class MovieLibrary extends Component {
  constructor(props) {
    ...
    this.containingTextMovies = this.containingTextMovies.bind(this);
    this.filteredGenreMovies = this.filteredGenreMovies.bind(this);
    this.bookmarkedMovies = this.bookmarkedMovies.bind(this);
  ...
  containingTextMovies() {
    const containingTextMoviesArray = this.props.movies.filter((movie) => {
    ...
    return containingTextMoviesArray;
  }

  filteredGenreMovies() {
    const filteredGenreMoviesArray = this.containingTextMovies().filter((movie) => {
      const { selectedGenre } = this.state;
      if (selectedGenre !== '') return movie.genre === selectedGenre;
      return movie;
    });
    return filteredGenreMoviesArray;
  }

  bookmarkedMovies() {
    const filteredMoviesArray = this.filteredGenreMovies().filter((movie) => {
  ...
  render() {
    const filteredMovies = this.bookmarkedMovies();
