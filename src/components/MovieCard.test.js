...
describe('Verifica o componente <MovieCard />', () => {
  ...
  it.skip('Será validadado se o componente é renderizado com sucesso', () => {
    render(<MovieCard movie={movie} />);
  });
  
  it.skip('Será validado se o a imagem do filme é renderizada dentro de uma tag "img"', () => {
  ...
  it.skip('Será validado se o título do filme é renderizado com sucesso', () => {
  ...
  it.skip('Será validado se o subtítulo do filme é renderizado com sucesso', () => {
    const { getByText } = render(<MovieCard movie={movie} />);
  ...
  it.skip('Será validado se a sinopse do filme é renderizada com sucesso', () => {
    const { getByText } = render(<MovieCard movie={movie} />);
    const storyline = getByText('Movie Storyline 1');
    expect(storyline).toBeInTheDocument();
  });

  it.skip('Será validado se a avaliação do filme é renderizada com sucesso', () => {
  ...
  it.skip('Será validado se a avaliação do filme é renderizada com o valor correto', () => {
