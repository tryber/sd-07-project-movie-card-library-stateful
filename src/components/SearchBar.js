        ...
        return (
            <div>
                <form data-testid="search-bar-form">
                    ...
                    <input data-testid="checkbox-input" onChange={onBookmarkedChange} type="checkbox" id="favorits-input" checked={bookmarkedOnly} />
                    <label data-testid="select-input-label" htmlFor="select-gender" value={selectedGenre}>Filtrar por gênero</label>
                    <select data-testid="select-input" onChange={onSelectedGenreChange} value={selectedGenre} id="select-gender">
